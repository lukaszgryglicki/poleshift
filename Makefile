GO_BIN_FILES=cmd/poleshift/poleshift.go
GO_BIN_CMDS=poleshift/cmd/poleshift
...
poleshift: cmd/poleshift/poleshift.go
	 ${GO_ENV} ${GO_BUILD} -o poleshift cmd/poleshift/poleshift.go
